...
import {
  EqualsPredicate,
  isNotNil as t3YhiD3Bk,
  isOptional as _krhmaXp,
  isString as Dp8dLCd6c,
  partialLeft,
  pluckProperty,
  rxSelectProperty
 ...
 */
export function isLineHeightOptionsType(
  aValue: any
): aValue is LineHeightOptionsType {
  return (
    t3YhiD3Bk(aValue) && _krhmaXp(aValue[KEY_LINE_HEIGHT_OPTIONS], Dp8dLCd6c)
  );
}
 ...
 */
export const selectLineHeightOptions: (
  aDefault?: string
) => UnaryFunction<LineHeightOptionsType, string> = partialLeft(
  pluckProperty,
 ...
 */
export const rxSelectLineHeightOptions: (
  aDefault?: string,
  aCmp?: EqualsPredicate<string>
) => OperatorFunction<LineHeightOptionsType, string> = partialLeft(
  rxSelectProperty,
  KEY_LINE_HEIGHT_OPTIONS
);
