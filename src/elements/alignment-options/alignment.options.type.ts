 ...
 */
export function isAlignmentOptionsType(
  aValue: any
): aValue is AlignmentOptionsType {
  return (
    t3YhiD3Bk(aValue) && _krhmaXp(aValue[KEY_ALIGNMENT_OPTIONS], Dp8dLCd6c)
  );
}
 ...
 */
export const selectAlignmentOptions: (
  aDefault?: string
) => UnaryFunction<AlignmentOptionsType, string> = partialLeft(
  pluckProperty,
 ...
 */
export const rxSelectAlignmentOptions: (
  aDefault?: string,
  aCmp?: EqualsPredicate<string>
) => OperatorFunction<AlignmentOptionsType, string> = partialLeft(
  rxSelectProperty,
  KEY_ALIGNMENT_OPTIONS
);
